 ...
 */
public class LoginActivity extends AppCompatActivity implements AsyncResponse, GoogleApiClient.OnConnectionFailedListener, LoaderCallbacks<Cursor> {

    //Create Database instance in order to be able to query for users
    DatabaseManager database_manager = new DatabaseManager();
    public ArrayList<GetUsername> userlist = new ArrayList<GetUsername>();
    /**
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            String type = "login";
            //BackgroundWorker backgroundWorker = new BackgroundWorker(this);
            backgroundWorker.execute(type, userEmail);
            loadMainMenu();
            //PostResponseAsyncTask taskRead = new PostResponseAsyncTask(LoginActivity.this, this);
            //taskRead.execute("http://ryandeal.me/BHlogin.php?UserName=" + userEmail);
